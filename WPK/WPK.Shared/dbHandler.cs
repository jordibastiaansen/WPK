...
namespace WPK
{
    static class dbHandler
    {
        ...
        public static CustomerInfo[] GetCustomers()
        {
            ...
            list[5] = new CustomerInfo() { adress = "Schoutstraat 20a, 4204BC, Gorinchem, Nederland", name = "Donald Trump", telephone = "0275-576643" };
            list[6] = new CustomerInfo() { adress = "Schoutstraat 11a, 4204BC, Gorinchem, Nederland", name = "Kakkerlak", telephone = "0275-576643" };
